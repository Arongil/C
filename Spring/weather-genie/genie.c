...
int main(int argc, char **argv) {
    if (argc != 2) {
        fprintf(stderr, argc < 2 ? "Please input a zip code" : "Please input just one zip code");
        return 1;
    }

    char *url = calloc(200, sizeof(char));
    sprintf(url, "http://api.openweathermap.org/data/2.5/weather?zip=%s&APPID=711f6a12520d4900ad4da340153c9877", argv[1]);
